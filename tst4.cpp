        ...
        switch(opcion)
        {
            case 1: // Añadir un dato nuevo
                if (numeroFichas < 1000)   // Si queda hueco
                {
                    ...
                    cin >> fichas[numeroFichas].title;
                    cout << "Introduce el Texto: \n";
                    getline(cin, fichas[numeroFichas].text);
                    getch();
                    cout << "Introduce el dia: ";
                    cin >> fichas[numeroFichas].newfecha.day;
                    cout << "Introduce el mes: ";
                    cin >> fichas[numeroFichas].newfecha.month;
                    cout << "Introduce el year: ";
                    cin >> fichas[numeroFichas].newfecha.year;
            ...
            case 2: // Mostrar todos
                for (i=0; i<numeroFichas; i++)
                    cout << "Nombre: " << fichas[i].title
                        << " Fecha: " << fichas[i].newfecha.day << '/' << fichas[i].newfecha.month
                        << '/' << fichas[i].newfecha.year << endl;
                    cout << "\n" << fichas[i].text << endl;
                break;
